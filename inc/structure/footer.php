...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		?>
		<div class="site-info">
			<p>Магазин взуття «<a href="<?php echo esc_url( home_url( '/' ) ); ?>">Танго</a>» 2016</p>
			<p style="text-align:right; color:#cccccc; font-style: italic; font-size:1.2em">Танго! Танцюєм разом!</p>
		</div><!-- .site-info -->
		<?php
	}
}
